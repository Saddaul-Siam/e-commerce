  ...
  return (
    <ul className="space-y-3 text-base font-light text-gray-600">
      <li>
        ...
        <span className="font-semibold text-gray-500">Rocket Payment </span>
        সিলেক্ট করে কমপ্লিট পেমেন্ট বাটনে ক্লিক করলে রকেট পেমেন্ট
        <span className="font-semibold text-gray-500"> Popup </span>
        ওপেন হবে।
      </li>
      <li>
        <FcOk className="mr-3 inline" />
      ...
      <li>
        <FcOk className="mr-3 inline" />
        <span className="font-semibold text-gray-500">Confirm </span>এ ক্লিক
