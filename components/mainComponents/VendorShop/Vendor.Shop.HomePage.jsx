    ...
    <div>
      ...
      <div className=" grid grid-cols-1 gap-2 sm:grid-cols-3">
        ...
        <div className="h-[312px] w-full space-y-2">
          <div className="relative flex h-1/2 w-full cursor-pointer bg-white p-2">
            ...
            <div className="relative h-full w-1/2">
              <h3 className="pt-2 text-2xl text-gray-600">Products Name</h3>
      ...
      <div className="mt-10">
        <h2 className="pb-5 text-2xl font-bold italic text-gray-700">
          <AiFillThunderbolt className="inline text-red-600/90" /> Best Sealing
          Product
        </h2>
        <div>
      ...
      <div className="mt-10">
        <h2 className="pb-5 text-2xl font-bold italic text-gray-700">
          <AiFillThunderbolt className="inline text-red-600/90" /> Just For You
        </h2>
